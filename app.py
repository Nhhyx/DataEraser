...
def deref_links():
    ...
    liens = [
        ...
        {"moteur": "DuckDuckGo",        "description": "Email au DPO",                                  "url": "https://duckduckgo.com/duckduckgo-help-pages/results/can-a-result-be-removed",  "email": "dpo@duckduckgo.com", "delai": "~30 jours",  "type": "email"},
        {"moteur": "Yahoo",             "description": "Centre d'aide - suppression",                   "url": "https://fr.aide.yahoo.com/kb/search-for-desktop/Quest-ce-que-le-d%C3%A9r%C3%A9f%C3%A9rencement-et-pourquoi-les-r%C3%A9sultats-Yahoo-Search-seront-ils-d%C3%A9r%C3%A9f%C3%A9renc%C3%A9s-par-rapport-%C3%A0-mon-nom-complet-en-Europe-ou-au-Royaume-Uni%C2%A0-sln28252.html",        "delai": "~30 jours",  "type": "formulaire"},
